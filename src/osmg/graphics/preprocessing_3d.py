...
def add_data__parent_nodes(
    ...
    """
    Add a trace containing parent nodes.
...
def add_data__internal_nodes(
    ...
    """
    Add a trace containing internal nodes.
...
def add_data__release_nodes(
    ...
    """
    Add a trace containing release nodes.
...
def add_data__twonodelinks(data_dict: list[dict[str, object]], mdl: Model) -> None:
    """
    Add a trace containing twonodelink elements.
...
def add_data__frame_offsets(data_dict: list[dict[str, object]], mdl: Model) -> None:
    """
    Add a trace containing frame element rigid offset lines.
...
def add_data__frame_axes(
    ...
    """
    Add a trace containing frame element local axis lines.
...
def add_data__zerolength_axes(
    ...
    """
    Add a trace containing zerolength element local axis lines.
...
def add_data__global_axes(
    ...
    """
    Add a trace containing global axes.
...
def add_data__extruded_frames_mesh(
    ...
    """
    Add a trace containing frame element extrusion mesh.
