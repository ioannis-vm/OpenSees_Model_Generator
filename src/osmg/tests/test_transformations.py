...
class TestRotationMatrix3D:
    ...
    def test_rotation_matrix_3d_invalid_axis(self):
...
class TestTransformationMatrix:
    ...
    def test_transformation_matrix_permuted_axes(self):
...
class TestLocalAxesFromPointsAndAngle:
    ...
    def test_local_axes_horizontal(self):
        ...
        assert np.allclose(result[0], expected_x)
        assert np.allclose(result[1], expected_y)
        assert np.allclose(result[2], expected_z)

    def test_local_axes_vertical(self):
    ...
    def test_local_axes_vertical_upside_down(self):
