...
def list_of_beams_to_mesh_edges_external(beams):
    ...
    elasticBeamColumn elements, and maps those edges to their
    generatory elasticBeamColumn elements.
    Args:
        beams (list[elasticBeamColumn]): All BeamColumn elements
...
def closed_beam_sequences(beams):
    ...
    Args:
        beams (list[elasticBeamColumn]): All BeamColumn elements
              ...
              performed.
    Returns:
        sequences (list[list[elasticBeamColumn]]):
...
def list_of_beams_to_mesh_edges_internal(beams):
    ...
    TODO (explain)
    Args:
        beams (list[elasticBeamColumn]): TODO.
    Returns:
        edges (list[Edge]): Generated edges.
...
def calculate_tributary_areas(
        beams: list[elasticBeamColumnElement]) -> tuple[list[npt.NDArray[np.float64]], list[Any]]:
    """
    TODO - docstring
    """
